<div class="max-w-md p-0 mx-auto card content" x-data="{ showList: false }">
    <div class="p-6 text-center border-b">
        <h1 class="mb-0">Welcome to Podcaster for Statamic!</h1>
        <p>Let's get this podcast going. Your listeners are waiting.</p>
    </div>
    <div class="px-6 py-3">
        <a href="{{ cp_route('globals.update', 'podcast') }}" class="flex items-start p-2 my-8 rounded-md hover:bg-blue-100 group">
            <div class="flex items-center justify-center w-12 h-12 p-2 mr-3 text-blue-800 bg-blue-100 rounded-full group-hover:bg-blue-200">
        ...
        <a href="{{ cp_route('collections.entries.create', ['episodes', Statamic\Facades\Site::default()->handle()]) }}" class="flex items-start p-2 mb-8 rounded-md hover:bg-blue-100 group">
            <div class="flex items-center justify-center w-12 h-12 p-2 mr-3 text-blue-900 bg-blue-100 rounded-full group-hover:bg-blue-200">
        ...
        <a href="{{ cp_route('globals.update', 'theme') }}" class="flex items-start p-2 mb-8 rounded-md hover:bg-blue-100 group">
            <div class="flex items-center justify-center w-12 h-12 p-2 mr-3 text-blue-900 bg-blue-100 rounded-full group-hover:bg-blue-200">
        ...
        <button x-on:click="showList = true" class="flex p-2 text-left rounded-md items-star group" x-bind:class="!showList && 'hover:bg-blue-100'">
            <div class="flex items-center justify-center w-12 h-12 p-2 mr-3 text-blue-900 bg-blue-100 rounded-full group-hover:bg-blue-200">
            ...
            <div class="flex-1">
                ...
                <ul class="pt-4 mt-4 space-y-2 text-base border-t" x-show="showList" x-cloak>
                    <li>
